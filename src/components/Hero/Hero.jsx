...
const Hero = () => {
  return (
    <section>
      <div className="bg-[#ffe8e8] rounded-3xl container grid grid-cols-1 md:grid-cols-2 gap-6 min-h-[650px]">
        {/* Text section */}
        <div className="flex flex-col justify-center xl:pr-40">
          <div className="mt-24 mb-10 md:mt-0 md:mb-0 space-y-6 text-center md:text-left">
            ...
            >
              we believe that growth is driven by innovation. Our team is dedicated to providing cutting-edge solutions that empower your business....
            </motion.p>
            <motion.div
